...
namespace AuthService.Infrastructure.RepositoryImplementations
{
    public class ApplicationUserRepository : GenericRepository<ApplicationUser>, IApplicationUserRepository
    {
        ...
        public async Task<ApplicationUser> GetUserByUsernameAsync(string userName, bool trackStatus) => await FindByCondition(x => x.UserName.ToLower() == userName.ToLower(), trackStatus).Include(x => x.Role).FirstOrDefaultAsync();

        public async Task<string> DeleteUserAccount(Guid id)
        {
